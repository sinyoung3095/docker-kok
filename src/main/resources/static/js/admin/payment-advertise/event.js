...
// 목록
service.getPaymentAdvertiseList(layout.showList);
...
confirmBtn.addEventListener("click", (e) => {
    listItem.forEach(async (listItem) => {
        ...
        if(categoryTag){
            ...
            return await service.getPaymentAdvertiseList(layout.showList, page, keyword, category);
        }
        // else if(!categoryTag) {
        //     if (pagination) {
        //         delete pagination.dataset.category;
...
search.addEventListener("click", async (e) => {
    ...
    await service.getPaymentAdvertiseList(layout.showList, page, keyword, category);
});
...
pagination.addEventListener("click", async (e) => {
    ...
    await service.getPaymentAdvertiseList(layout.showList, e.target.dataset.page, keyword, category);
